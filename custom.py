...
class GuitarixSimple(Config):
    ...
    def on_enter(self):
        ...
        engine.register_footswitch(2, lambda x: self.switch(x, 11, 2))
        engine.register_footswitch(3, lambda x: self.switch(x, 12, 3))
...
class RakBizConfig(RakConfig):
    ...
    def __on_exit(self, pressed: bool):
        """Called when the "exit footswitch" is pressed."""
        if pressed:
    ...
    def set_presets(self):
        ...
        engine.register_footswitch(3, self.__on_exit)
